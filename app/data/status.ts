...
export const milestones: Milestone[] = [
  { id:'M1', label:'the spine · shipped', state:'done', title:'The spine is walking — and shipped.',
    body:'Memory MCP, Telegram bridge, PreToolUse gate, approval flow, persona scaffolding. Now decomposed into seven packages, published to npm and installable with create-fortytwo; CI green on every repo.' },
